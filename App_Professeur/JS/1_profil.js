...
import { profileService } from `${baseUrl}App_Professeur/JS/services/1_profil.js`;
import { specialtyService } from `${baseUrl}App_Professeur/JS/services/specialty_service.js`;
