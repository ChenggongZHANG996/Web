...
export async function initialize() {
  try {
    console.log(
      "%c=== Initialisation du Tableau de Bord DÉBUT ===",
    ...
    console.log(
      "%c📊 Récupération des statistiques du tableau de bord...",
    ...
    console.log(
      "%c📈 Statistiques reçues:",
      "color: #00BCD4; font-weight: bold;",
      {
        "Cours actifs": activeCoursesCount,
        "Étudiants actifs": activeStudentsCount,
    ...
    if (coursesCountElement) {
      ...
      console.log(
        "%c📚 Affichage du nombre de cours mis à jour:",
        "color: #2196F3",
        activeCoursesCount
      );
    }
    ...
    if (studentsCountElement) {
      ...
      console.log(
        "%c👥 Affichage du nombre d'étudiants mis à jour:",
        "color: #9C27B0",
        activeStudentsCount
      );
    }
    ...
    if (teachingHoursElement) {
      ...
      console.log(
        "%c⏱️ Affichage des heures d'enseignement mis à jour:",
        "color: #FF9800",
    ...
    console.log(
      "%c=== Initialisation du Tableau de Bord TERMINÉE ===",
      "color: #4CAF50; font-weight: bold; font-size: 14px;"
    );
  } catch (error) {
    console.error(
      "%c❌ Erreur lors de l'initialisation du tableau de bord:",
